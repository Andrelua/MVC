...
class AdminController {
    ...
    public function insert() {
        ...
        try {
            ...
            echo '<script>location.href="http://localhost/MVC/index.php?pagina=admin&metodo=create";</script>';
        }
    ...
    public function update() {
        ...
        try {
            ...
            echo '<script>alert("'.$e->getMessage().'");</script>';
            echo '<script>location.href="http://localhost/MVC/index.php?pagina=admin&metodo=change&id='.$_POST['id'].'";</script>';
        }
